  ...
  const researchProjects = [
    {
      ...
      details: [
        ...
        <span key="links">Links: <a href="https://www.remotelabor.ai/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Website</a> | <a href="https://scale.com/research/rli" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Scale AI</a> | <a href="https://www.washingtonpost.com/technology/interactive/2026/ai-jobs-automation/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Washington Post</a>.</span>,
    ...
    },
    {
      ...
      details: [
        ...
        <span key="citation">Cited by <a href="https://data.x.ai/2025-08-20-xai-risk-management-framework.pdf" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">xAI's Risk Management Framework</a>.</span>,
        <span key="links">Links: <a href="https://www.emergent-values.ai/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Website</a> | <a href="https://www.wired.com/story/xai-make-ai-more-like-trump/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Wired</a> | <a href="https://www.forbes.com/sites/lanceeliot/2025/02/28/ai-hiding-emergent-human-values-that-include-ai-survival-topping-human-lives/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Forbes</a>.</span>,
    ...
    },
    {
      ...
      details: [
        ...
        <span key="invited"><a href="https://x.com/tomekkorbak/status/1828154620138660352" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Invited to present</a> at the UK Government AI Safety Institute. Cited by OpenAI and the Singapore Consensus on Global AI Safety Research Priorities. Featured in TechCrunch as research paper of the week.</span>,
        <span key="links">Links: <a href="https://www.safetywashing.ai/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Website</a> | <a href="https://github.com/centerforaisafety/safetywashing" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Codebase</a> | <a href="https://x.com/notRichardRen/status/1819427976309780574" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Thread</a> | <a href="https://techcrunch.com/2024/08/04/many-safety-evaluations-for-ai-models-have-significant-limitations/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">TechCrunch</a>.</span>,
