    ...
    <div className="max-w-3xl mx-auto px-6 py-8 font-serif">
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-700 mb-6">
          I have co-led the most comprehensive empirical meta-analysis of AI safety benchmarks to date (<a href="https://arxiv.org/abs/2407.21792" className="text-blue-600 hover:underline">Safetywashing</a>, NeurIPS '24) as well as the development of an AI honesty benchmark (<a href="https://arxiv.org/abs/2503.03750" className="text-blue-600 hover:underline">MASK</a>). My co-1st-authored work has been presented at the UK Government AI Safety Institute (by invitation), cited by the <a href="https://arxiv.org/pdf/2506.20702" className="text-blue-600 hover:underline">Singapore Consensus</a> on AI Safety Priorities, published at NeurIPS, and used by researchers at xAI (<a href="https://data.x.ai/2025-08-20-grok-4-model-card.pdf" className="text-blue-600 hover:underline">1</a>), OpenAI (<a href="https://openai.notion.site/Research-directions-0df8dd8136004615b0936bf48eb6aeb8" className="text-blue-600 hover:underline">1</a>, <a href="https://cdn.openai.com/papers/trading-inference-time-compute-for-adversarial-robustness-20250121_1.pdf" className="text-blue-600 hover:underline">2</a>), and Anthropic (<a href="https://alignment.anthropic.com/2025/honesty-elicitation/" className="text-blue-600 hover:underline">1</a>).
        </p>
        <button
